...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display 'Call To Action' Buttons",
                   "id" => $shortname."_buttons",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display Call To Action buttons. "),
			...
			array( "name" => "Display Media Section",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Media Section on the homepage. "),
				   
			array( "name" => "Display Homepage Footer Quote",
                   "id" => $shortname."_footer_quote",
                   "type" => "checkbox2",
                   "std" => "on",
			...
			array( "name" => "Display Landscape",
                   "id" => $shortname."_display_landscape",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Landscape on the homepage. "),

			array( "type" => "clearfix",),
			
			array( "name" => "Button #1 Text",
				   "id" => $shortname."_button1_text",
				   "std" => "",
                   "type" => "text",
				   "desc" => "Enter text below. "),
				   
			array( "name" => "Button #1 URL",
				   "id" => $shortname."_button1_url",
				   "std" => "#",
                   "type" => "text",
				   "desc" => "Enter text below. "),
				   
			array( "name" => "Button #2 Text",
				   "id" => $shortname."_button2_text",
				   "std" => "",
                   "type" => "text",
				   "desc" => "Enter text below. "),
				   
			array( "name" => "Button #2 URL",
				   "id" => $shortname."_button2_url",
				   "std" => "#",
                   "type" => "text",
				   "desc" => "Enter text below. "),
			...
			array( "name" => "Content Area 1 Page",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Choose the page you would like to display in the content area. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			...
			array( "name" => "Footer Quote Text",
                   "id" => $shortname."_footer_quote_text",
                   "std" => "We offer the highest quality and most advanced web design services anywhere",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage footer quote."),
				   
			array( "name" => "Footer Quote Url",
                   "id" => $shortname."_footer_quote_url",
                   "std" => "#",
                   "type" => "text",
				   "desc" => "Place the URL below. "),
				   
			array( "name" => "Exclude categories from homepage media section",
				   "id" => $shortname."_exlcats_media",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "By default the homepage displays most recent posts in media section. However, if you would like to exlcude certain category from the list you can do so here. ",
				   "usefor" => "categories",
				   "options" => $cats_ids),
